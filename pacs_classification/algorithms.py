...
from pacs_classification import networks
from pacs_classification.lib.misc import random_pairs_of_minibatches
...
class ERM(Algorithm):
    ...
    def __init__(self, input_shape, num_classes, num_domains=None):
        super(ERM, self).__init__(input_shape, num_classes, num_domains)
        self.featurizer = networks.ResNet()
